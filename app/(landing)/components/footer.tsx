      ...
      <div className="mx-auto max-w-7xl">
        <div className="rounded-3xl border border-white/30 bg-white/70 p-10 shadow-[0_8px_32px_0_rgba(15,23,42,0.1)] backdrop-blur-2xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-3">
            ...
            <div className="lg:col-span-1">
              ...
              <button
                ...
                className="mt-4 w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-green-500 to-green-600 px-4 py-3 text-sm font-medium text-white shadow-lg transition-all hover:scale-105 hover:from-green-600 hover:to-green-700"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-10 border-t border-slate-200 pt-10">
            <h4 className="mb-4 text-center text-sm font-bold uppercase tracking-wide text-slate-900">
              Lokasi Asyifa Koi Farm
            </h4>
            <div className="relative overflow-hidden rounded-2xl border border-white/40 shadow-lg">
              <iframe
                src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3951.5!2d${contactData.longitude}!3d${contactData.latitude}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zOMKwMDMnMzQuNiJTIDExMsKwMTgnNDkuNiJF!5e0!3m2!1sen!2sid!4v1234567890123!5m2!1sen!2sid`}
                width="100%"
                height="300"
                style={{ border: 0 }}
                allowFullScreen
              ...
              <div className="absolute bottom-4 right-4">
                <a
                  ...
                  className="flex items-center gap-2 rounded-lg bg-white/90 px-4 py-2 text-sm font-medium text-slate-700 shadow-lg backdrop-blur-sm transition-all hover:bg-white hover:scale-105"
                >
